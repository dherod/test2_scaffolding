...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { administered: @medicine.administered, description: @medicine.description, name: @medicine.name, quantity: @medicine.quantity }
    end
  ...
  test "should update medicine" do
    put :update, id: @medicine, medicine: { administered: @medicine.administered, description: @medicine.description, name: @medicine.name, quantity: @medicine.quantity }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
